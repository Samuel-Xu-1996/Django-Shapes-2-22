...
function renderLegend(){
	drawLegend(COLOR.MACHINE.TYPE_A,25,'7 inch Billet');
	drawLegend(COLOR.MACHINE.TYPE_B,50,'11 inch Billet');
	drawLegend(COLOR.MACHINE.TYPE_C,75,'14 inch Billet');
	drawLegend(COLOR.MACHINE.TYPE_D,100,'9 inch Billet');
	drawLegend(COLOR.MACHINE.TYPE_E,125,'Chopped Log');
	drawLegend(COLOR.MACHINE.TYPE_F,150,'Unhomogenized Log');
	drawLegend(COLOR.MACHINE.TYPE_G,175,'Homogenized Log');
}
...
function renderLayer03Right(){
	drawLayer03Right($("#layer03_right_chart01 canvas").get(0),"#027825",0.908);
	drawLayer03Right($("#layer03_right_chart02 canvas").get(0),"#006DD6",0.027);
	drawLayer03Right($("#layer03_right_chart03 canvas").get(0),"#238681",0.065);
}
		...
		myChart.setOption(
					 {
						...
						legend: {
							...
							x : 'center',
							y : 'bottom',
							data:['7 inch Billet','11 inch Billet','14 inch Billet','9 inch Billet','Chopped Log','Unhomogenized Log','Homogenized Log']
						},
						toolbox: {
						},
						label:{
						...
						series : [
							{
								...
								//roseType : 'area',
								data:[
									{value:13796, name:'7 inch Billet'},
									{value:18846, name:'11 inch Billet'},
									{value:0, name:'14 inch Billet'},
									{value:20026, name:'9 inch Billet'},
									{value:0, name:'Chopped Log'},
									{value:74706, name:'Unhomogenized Log'},
									{value:62991, name:'Homogenized Log'}
								]
							}
						]
					}
			...
			series : [
				{
					...
					symbol:'none',
					data:[230882, 103936, 0, 0, 0, 16183, 108743,0,1950,4489,0,0,46656,101723,0,14037,89984,0,27749,7185,1107,38184,20000,0,0,0,145484,81133,6605,27286]
				}
			]
		}
...
function getLatestDays(num)
{
	...
	var returnDays = returnDays.reverse();
	return returnDays;
}